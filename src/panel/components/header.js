    ...
    render() {
        ...
        return (
            <div className="header">
                ...
                <span className="header__account">{user} ({unreadCount})</span>
                <a className="header__compose" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 841.9 18 18" className="header__icon-compose">
                        <path d="M5.4,855.5l3.7-1.4l8.4-8.4c0.6-0.6,0.6-1.7,0-2.3c-0.6-0.6-1.7-0.6-2.3,0l-8.4,8.4L5.4,855.5z M16,857.9H2v-14h6.5l2-2H0v18h18v-9.6l-2,2L16,857.9L16,857.9z"/>
